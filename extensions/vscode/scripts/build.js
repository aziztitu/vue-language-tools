...
require("esbuild")
  .context({
    entryPoints: {
      ...
      "dist/server":
        "./node_modules/@azee/vue-language-server/bin/vue-language-server.js",
      "node_modules/vue-language-core-pack/index":
        "./node_modules/@azee/vue-language-core/index.js",
      "node_modules/vue-typescript-plugin-pack/index":
        "./node_modules/@azee/vue-typescript-plugin/index.js",
    },
    bundle: true,
        ...
        setup(build) {
          build.onEnd(() => {
            ...
            fs.cpSync(
              path.resolve(
                __dirname,
                "../node_modules/@azee/vue-language-core/schemas/vue-tsconfig.schema.json",
              ),
              path.resolve(
                __dirname,
                "../dist/schemas/vue-tsconfig.schema.json",
              ),
            );
          });
        },
