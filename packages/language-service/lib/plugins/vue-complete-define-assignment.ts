...
import { TextRange, tsCodegen, VueVirtualCode } from "@azee/vue-language-core";
      ...
      return {
        ...
        async provideCompletionItems(document) {
          ...
          addDefineCompletionItem(
            ...
            scriptSetupRanges.withDefaults?.exp ??
              scriptSetupRanges.defineProps?.exp,
            "props",
          );
          addDefineCompletionItem(
          ...
          function addDefineCompletionItem(
            ...
            for (const [, map] of mappings) {
              for (const [generatedOffset] of map.toGeneratedLocation(
                scriptSetup!.startTagEnd + exp.start,
              )) {
