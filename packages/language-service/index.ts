...
export * from "@azee/vue-language-core";
...
import { parse, VueCompilerOptions } from "@azee/vue-language-core";
import { proxyLanguageServiceForVue } from "@azee/vue-typescript-plugin/lib/common";
import { collectExtractProps } from "@azee/vue-typescript-plugin/lib/requests/collectExtractProps";
import { getComponentDirectives } from "@azee/vue-typescript-plugin/lib/requests/getComponentDirectives";
import { getComponentEvents } from "@azee/vue-typescript-plugin/lib/requests/getComponentEvents";
import { getComponentNames } from "@azee/vue-typescript-plugin/lib/requests/getComponentNames";
import { getComponentProps } from "@azee/vue-typescript-plugin/lib/requests/getComponentProps";
import { getElementAttrs } from "@azee/vue-typescript-plugin/lib/requests/getElementAttrs";
import { getImportPathForFile } from "@azee/vue-typescript-plugin/lib/requests/getImportPathForFile";
import { getPropertiesAtLocation } from "@azee/vue-typescript-plugin/lib/requests/getPropertiesAtLocation";
import type { RequestContext } from "@azee/vue-typescript-plugin/lib/requests/types";
import { URI } from "vscode-uri";
import {
  convertAttrName,
  convertTagName,
  detect,
} from "./lib/ideFeatures/nameCasing";
...
export function getFullLanguageServicePlugins(
  ...
  function getTsPluginClientForLSP(
...
export function getHybridModeLanguageServicePlugins(
  ts: typeof import("typescript"),
  getTsPluginClient: typeof import("@azee/vue-typescript-plugin/lib/client"),
) {
  const plugins = [
